...
set(_nuke_KNOWN_VERSIONS 9.0 10.0 10.5 11.0 11.1 11.2 11.3 12.0 12.1 12.2)
...
if (UNIX)
    set_target_properties(Nuke::NDK
        PROPERTIES
            IMPORTED_LOCATION ${NUKE_ROOT}/@CMAKE_SHARED_LIBRARY_PREFIX@DDImage@CMAKE_SHARED_LIBRARY_SUFFIX@
            INTERFACE_INCLUDE_DIRECTORIES ${NUKE_ROOT}/include
            INTERFACE_LINK_LIBRARIES ${NUKE_ROOT}/@CMAKE_SHARED_LIBRARY_PREFIX@DDImage@CMAKE_SHARED_LIBRARY_SUFFIX@
